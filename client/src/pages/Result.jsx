...
const Result = () => {
  const { resulImage, image } = useContext(AppContext);
  ...
  return (
    <div className="mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]">
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        {/* buttons */}
        { resulImage && <div className=" flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
